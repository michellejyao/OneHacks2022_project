...
def register():
    ...
    db_conn = psycopg2.connect("postgresql://chantal:onehacks2022-environment@free-tier6.gcp-asia-southeast1.cockroachlabs.cloud:26257/defaultdb?sslmode=verify-full&options=--cluster%3Donehackss-2022-2774")
